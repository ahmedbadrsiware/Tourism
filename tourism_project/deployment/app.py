...
# Prepare input data (column names/values match the training data exactly)
...
# Classification threshold (same as used in train.py)
...
if st.button("Predict"):
    ...
    st.write(f"Purchase probability: {prob:.1%}")
